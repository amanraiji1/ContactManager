...
public class AddContactServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Contact contact = new Contact(name, phone, email, user.getId());
            
            ContactDao dao = new ContactDao(ConnectionProvider.getConnection());
            if(dao.saveContact(contact)){
                Message m = new Message("Contact added!", "success", "alert-success");
                s.setAttribute("msg", m);
                response.sendRedirect("profile.jsp");
            }
            else{
                
                Message m = new Message("Phone already exists!", "error", "alert-danger");
                s.setAttribute("msg", m);
                response.sendRedirect("profile.jsp");
            }
